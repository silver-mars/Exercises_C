...
* всем у кого в работе есть большое число рутинных операций на unix-машинах
* кому приходится много работать в консоли
* кому приходится много писать (неважно - заполнять таски в задачах, вести документацию или кодить)

А также если вам часто приходится:
* пользоваться DevTools, выискивая ошибки на фронте,
...
[Принцип первый: hotkeys](#bash-оболочка-hotkeys)<br>
[Принцип второй: упрощение команд](#оптимизация-написания-команд)<br>
[Принцип третий: использование алиасов и переменных](#сокращение-команд-и-длинных-аргументов)
[Небольшой бонус](#хитросплетённые-команды-о-существовании-которых-нужно-знать-и-периодически-подглядывать-в-них-если-они-вдруг-становятся-актуальны-а-вы-их-не-помните)<br>
...
Ввод текста в консоль - основной способ общения с системой.<br>
...
Это довольно наглядный пример того, насколько быстрее простейшие операции можно выполнять в консоли. Разберём преимущества консоли чуть более подробно.
...
Но раз уж по долгу работы нам приходится работать в консоли, то я предлагаю делать это быстро, профессионально и с минимумом усилий, вспоминая древнюю истину:<br>
...
2-ой способ, как вы уже наверное догадались - использование hotkey.<br>
...
Уже здесь, как вы понимаете, можно довольно быстро ускориться, либо сразу прыгнув в начало консоли "Ctrl + A" и/либо перескочив нужные нам слова "Ctrl + Right | Ctrl + Left".<br>
