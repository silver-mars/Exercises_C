...
* всем, кто преимущественно работает в графической оболочке, но также имеет дело с большим количеством рутинных операций на unix-машинах
...
Данная статья содержит упор на совместное использование GUI (привычной нам и интуитивно понятной графической оболочки) и выполнение команд в терминальном эмуляторе (иногда я буду называть её консолью).<br>
