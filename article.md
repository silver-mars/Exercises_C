...
Это комбинации клавиш, нажимая на которые вы совершаете определённые операции в системе. Они позволяют нам выполнять действия без необходимости использовать мышь или навигацию по меню и представляют собой один из самых простых, удобных и эффективных способов повысить производительность и скорость работы.<br>
...
**$(date +%F)** обозначает, что перед тем, как исполнить этот скрипт, выполняется команда **date +%F**, которая подставляет вместо себя текущую дату (в моём случае - 2023-12-30).
