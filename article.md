...
В качестве оболочки (внешний уровень операционной системы, интерпретатор позволяющий давать команды ядру операционной системы и получать от него ответы) я буду давать примеры на bash.
