...
Здесь я собрал все методы, которые сам использовал в своей практике, разделив их условно на три категории:
1. Как писать меньше букв в командах (или оптимизировать существующие.
2. Как вести поиск среди файлов более эффективно (чудеса grep'a, find'a и др.)
