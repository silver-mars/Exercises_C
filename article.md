...
>Теперь, вместо этого, введите Ctrl + Alt + T (или любой способ вызвать терминал) и введите:<br>
...
**Важно**, что при этом я не утверждаю что нужно пользоваться только консолью.<br>
